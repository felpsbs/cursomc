...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		Cliente cli2 = new Cliente(null, "Lucas", "email@gmail.com", "60537114033", TipoCliente.PESSOA_FISICA, encoder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("23123123123"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Santos", "335", null, "Centro", "21773412", cli2, c2);
